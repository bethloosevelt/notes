...
*               sets score to zero
* 
* UPDATE:  NO LONGER PART OF ADT SINCE IT IS 
*          NOT WELL SPECIFIED WITH RESPECT TO 
*          THE UNDO COMMAND AND PROBABLY JUST NOT
*          THAT USEFUL.
*     
*          ALSO, THE bpop.c CLIENT PROGRAM DOESN"T USE
*          IT.
